        ...
        <div className="absolute top-full left-0 mt-1 z-50 bg-bg border border-border rounded-lg shadow-lg w-[300px]">
          ...
          <div className="px-3 pt-3 pb-2 border-b border-border">
            ...
            <div className="flex flex-wrap gap-1.5">
              <button onClick={() => setQuick(0, '18:00')} className="px-2 py-1 text-[11px] rounded-md bg-bg-secondary hover:bg-bg-hover text-text-secondary transition-colors">{t('dt.today18')}</button>
                ...
                {QUICK_TIMES.map(qt => (
                  <button
                    ...
                    className={cn(
                      ...
                      selectedTime === qt ? 'bg-accent text-white' : 'bg-bg-secondary hover:bg-bg-hover text-text-secondary'
                    )}
                  >
                    {qt.replace(':00', 'h')}
                  </button>
